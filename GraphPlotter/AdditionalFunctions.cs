...
namespace GraphPlotter {
    public static class AdditionalFunctions {
        ...
        public static double cot(double a) { return Math.Cos(a)/Math.Sin(a); }

        public static double sec(double a) { return 1/Math.Cos(a); }

        public static double cosec(double a) { return 1/Math.Sin(a); }

        public static double arcsin(double a) { return Math.Asin(a); }

        public static double arctan(double a) { return Math.Atan(a); }

        public static double arccos(double a) { return Math.Acos(a); }

        public static double ln(double a) { return Math.Log(a); }

        public static double antilog(double a) { return Math.Pow(10, a); }
        ...
        /// <param name="xx"></param>
        /// <returns></returns>
        public static double arcsinh(double xx) {
            double x;
            int sign;
            if (xx == 0.0) return xx;
            if (xx < 0.0) {
